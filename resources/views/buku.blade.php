...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-title text-dark">Data</li>
            <li
                class="sidebar-item">
            ...
            <li
                class="sidebar-item">
                <a href="{{url('/peminjam')}}" class='sidebar-link'>
                                ...
                                <a href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="user-menu d-flex">
                                        <div class="user-name text-end me-3">
                                            <h6 class="mb-0 text-gray-600">Setyo</h6>
                            ...
                            <table class="table table-borderless mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Timothy & AVS</td>
                                        <td>Academi Crypto</td>
                                        <td>2023</td>
                                            <td>
                                                <!-- Button trigger for login form modal -->
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editbuku">
                                                    Edit
                                                </button>

                                                <!--login form Modal -->
                                                <div class="modal fade text-left" id="editbuku" tabindex="-1" aria-labelledby="myModalLabel33" aria-hidden="true" style="display: none;">
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel33">Edit Data </h4>
                                    ...
                                    <button type="button" class="btn btn-secondary">Ulasan</button>
                                </td>
                                    </tr>
                                </tbody>
                            </table>
