                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="form-group">
                                        <a href="{{url('tambahkategori')}}" class="btn btn-outline-primary">Tambah Kategori</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-borderless mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('/editkategori')}}" class="btn btn-primary">Edit</a>
                                            <a href="{{url('/detailkategori')}}" class="btn btn-secondary">Detail</a>
